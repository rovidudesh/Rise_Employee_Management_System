...
const AssignedTasksQuickView = () => {
  ...
  if (loading) {
    return (
      <div className="w-full max-w-lg bg-white dark:bg-slate-800 rounded-lg shadow-2xl dark:shadow-2xl dark:shadow-black/50 border border-gray-200 dark:border-gray-700 p-4 sm:p-6 h-fit transition-all duration-300 relative">
        ...
        <div className="relative z-10 flex justify-center items-center h-24 sm:h-32">
        ...
        <div className="space-y-2 sm:space-y-3 max-h-64 sm:max-h-96 overflow-y-auto">
          {tasks.map((task) => {
            ...
            return (
              <div
                key={task.id}
                className="bg-gray-50 dark:bg-slate-700 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-gray-600 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-600 transition-all duration-200 shadow-sm hover:shadow-md transform hover:-translate-y-0.5"
                onClick={() => handleTaskClick(task)}
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs sm:text-sm font-semibold text-gray-800 dark:text-gray-200 truncate pr-2 flex-1">
                    {task.title}
                  </span>
                  <span
