  ...
  const links = [
    {
      section: 'TASKS',
      items: [
        { href: '/manager', label: 'Chatbot', icon: <FaRobot className="mr-4 text-xl" /> },
        { href: '/manager/all-tasks', label: 'All Tasks', icon: <FaTasks className="mr-4 text-xl" /> },
      ],
    },
  ];
      ...
      >
        {links.map((section, idx) => (
          <div key={idx} className="mb-10">
            <h3 className="text-xl font-semibold text-gray-800 mb-8">{section.section}</h3>
            <nav>
              <ul>
